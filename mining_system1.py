...
class Mining_system:
    ...
    def mineSpawn(self):
        ...
        if self.tDic.get('x'+str(self.bte.x)+'y'+str(self.bte.y-1)+'z'+str(self.bte.z)) == None:
            ...
            self.tDic['x'+str(self.bte.x)+'y'+str(e.y)+'z'+str(self.bte.z)] = 's'
            self.builds.combine()
        ...
        for i in range(4):
            ...
            # potential cave wall.
            here = self.tDic.get('x'+str(x)+'y'+str(y)+'z'+str(z))
            below = self.tDic.get('x'+str(x)+'y'+str(y-1)+'z'+str(z))
            ...
            if here == None and (below == 's' or below == None):
                    ...
                    e.parent = self.builds
                    # Record newly spawned block on dictionary.
                    self.tDic['x'+str(x)+'y'+str(y)+'z'+str(z)] = 's'
